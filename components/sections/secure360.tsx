...
export function Secure360() {
  return (
    <section className="relative overflow-hidden bg-blue-light py-24">
      <div className="bg-grid-lines-dense-navy pointer-events-none absolute inset-0 opacity-60" />
          ...
          {secure360Steps.map((s, i) => (
            <FadeIn key={s.step} delay={i * 0.07}>
              <div className="flex h-full flex-col border border-navy/10 border-t-2 border-t-red bg-white p-6">
                ...
                <h3 className="mt-3 font-heading text-lg font-bold tracking-wide text-navy uppercase">
                  {s.title}
                </h3>
