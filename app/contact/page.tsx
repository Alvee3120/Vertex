        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 gap-12 lg:grid-cols-5">
            ...
            <FadeIn delay={0.1} className="lg:col-span-2">
              <div className="flex h-full flex-col justify-between gap-8 bg-navy p-8 text-white sm:p-10">
                <div>
                  ...
                  <div className="mt-6 space-y-6">
                    <div>
                      ...
                      <p className="text-sm text-white/60">{contactInfo.credentials}</p>
                      <p className="mt-1 text-sm text-white/70">{contactInfo.title}</p>
                    </div>

                    <a
                      href={`mailto:${contactInfo.email}`}
                      className="flex items-start gap-3 text-sm text-white/80 hover:text-white"
                    >
